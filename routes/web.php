...
Route::middleware(['auth', 'preventBackHistory'])->group(function(){
    ...
    //create user routes
    Route::get('/admin/users', [AdminDashboardController::class, 'usersIndex'])->name('admin.users.view_user');
    Route::get('/admin/users/create', [AdminDashboardController::class, 'usersCreate'])->name('admin.users.create_user');
    Route::post('/admin/users', [AdminDashboardController::class,'usersStore'])->name('admin.users.store');
    Route::get('/admin/users/{id}/edit', [AdminDashboardController::class, 'usersEdit'])->name('admin.users.edit_user');
    Route::put('/admin/users/{id}', [AdminDashboardController::class, 'usersUpdate'])->name('admin.users.update');
    Route::delete('/admin/users/{id}', [AdminDashboardController::class, 'usersDelete'])->name('admin.users.destroy');

    // Route::get('/users', [AdminDashboardController::class, 'usersIndex'])->name('admin.users.index');
    // Route::get('/users/create', [AdminDashboardController::class, 'usersCreate'])->name('admin.users.create');
    // Route::post('/users', [AdminDashboardController::class, 'usersStore'])->name('admin.users.store');

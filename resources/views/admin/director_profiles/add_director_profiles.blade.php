        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Director Profile</h5>
                            ...
                            <form action="{{ route('director_profiles.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <button type="submit" class="btn btn-primary">Add Director Profile</button>
                            </form>
                        </div>
                    </div>
                </div>
